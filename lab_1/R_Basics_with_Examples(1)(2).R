...
RPI_Weather_Week
head(RPI_Weather_Week) # head of the data frame, NOTE: it will show only 6 rows

str(RPI_Weather_Week) # takes a look at the structure of the dataframe
summary(RPI_Weather_Week) # summary of the dataframe

RPI_Weather_Week[1,] # shows first row
RPI_Weather_Week[,1] # shows first column

RPI_Weather_Week$snowed # shows column
...
# How to read a dataframe using read.csv()
